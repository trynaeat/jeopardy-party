<template>
<div class="podium">
   <h2 class="last-winnings"
      v-bind:class="{
         'positive': lastWinnings >=0,
         'negative': lastWinnings < 0,
         'hidden': !showLastWinnings,
      }">{{ player.lastWinnings >= 0 ? '+' : '' }}{{ player.lastWinnings }}
   </h2>
   ...
   <defs
      ...
      <linearGradient
         ...
         <stop
            id="stop4592"
            offset="0"
            style="stop-color:#1e4b84;stop-opacity:1;" />
         <stop
            id="stop4594"
            offset="1"
            style="stop-color:#2c7784;stop-opacity:0" />
      </linearGradient>
      <radialGradient
         gradientUnits="userSpaceOnUse"
         gradientTransform="matrix(2.255663,0.01337874,-0.00956232,1.6122103,-131.45063,-94.066731)"
         r="96.597786"
         fy="151.3381"
         fx="105.83873"
         cy="151.3381"
...
const lastWinningsShowTime = 5000;
...
export default Vue.extend({
  ...
  data: function () {
     return {
        showLastWinnings: false,
     };
  },
  computed: {
     winnings: function () {
        return (this.player as User).winnings;
     },
     lastWinnings: function() {
        return (this.player as User).lastWinnings;
     },
  },
  props: {
     height: String,
  ...
  watch: {
     winnings: function () {
        (this.showLastWinnings as any) = true;
        setTimeout(() => {
           (this.showLastWinnings as any) = false;
        }, lastWinningsShowTime);
     },
  },
})
</script>
